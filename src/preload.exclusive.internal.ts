...
export const exclusivePreload: ExclusiveRemote = {
  ...
  admin: {
    ...
    pageDePaiement: (orgId: string) => ipcRenderer.invoke(IPC.remoteAdminPageDePaiement, orgId),
    ...
    bulk: (input) => ipcRenderer.invoke(IPC.remoteAdminBulk, input),
    incidentsQueue: (query) => ipcRenderer.invoke(IPC.remoteAdminIncidentsQueue, query),
    incidentsSummary: () => ipcRenderer.invoke(IPC.remoteAdminIncidentsSummary),
