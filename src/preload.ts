...
const bridge: AmnBridge = {
  ...
  remote: {
    ...
    lookupInvitation: (token: string) => ipcRenderer.invoke(IPC.remoteLookupInvitation, token),
    relancerInvitation: (token: string) => ipcRenderer.invoke(IPC.remoteRelancerInvitation, token),
    signalerInvitation: (token: string) => ipcRenderer.invoke(IPC.remoteSignalerInvitation, token),
    ...
    locks: {
      list: () => ipcRenderer.invoke(IPC.remoteLocksList),
      set: (module, locked) => ipcRenderer.invoke(IPC.remoteLocksSet, { module, locked }),
    },
