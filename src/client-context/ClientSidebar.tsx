...
export const CLIENT_SECTIONS: Array<{ label: string; code: string; keys: string[] }> = [
  ...
  { label: 'Production', code: 'PR', keys: ['time', 'expenses', 'calculators', 'board', 'stock', 'suppliers', 'shifts', 'checklists', 'interventions', 'assembly', 'aftersales', 'bom', 'rounds', 'equipment', 'itineraries', 'stockForecast'] },
